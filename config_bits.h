...
/* configuration settings */
    #pragma config FULLRSSEL  = PRIORITY_7 /* Interrupt priority 7 assigned to shadow set */
    ...
    #pragma config UPLLIDIV = DIV_1		/* USB PLL input divider, divide by 1 */
    #pragma config UPLLEN   = OFF		/* USB PLL disabled */
    #pragma config FPLLODIV = DIV_1		/* PLL output divider, divide by 1 */
    #pragma config FNOSC    = PRIPLL	/* Primary oscillator (XT,HALF, EC) w/PLL */
    #pragma config FULLOSCEN  = OFF		/* Secondary oscillator disabled */
